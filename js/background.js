document.addEventListener('DOMContentLoaded', function() {
    ...
    particlesDiv.style.backgroundColor = '#000205'; // Matte black with a hint of blue
    ...
    particlesJS('particles-js', {
        "particles": {
            ...
            "color": {
                "value": ["#ff0000", "#00ff00", "#0000ff"] // Red, Green, Blue quarks
            },
            "shape": {
                "type": "circle",
                "stroke": {
            ...
            "line_linked": {
                "enable": true,
                "distance": 150,
                "color": "#ff0000", // Red glowing connections
                "opacity": 0.4,
                "width": 1,
                "shadow": {
                    "enable": true,
